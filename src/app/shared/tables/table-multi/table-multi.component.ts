...
import { TableActionData, TableActionType, TableColumn, TableView, TitlebarView } from '../table.model';
...
export class TableMultiComponent implements OnChanges, OnInit {
